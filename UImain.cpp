...
void plot(float xpointmin, float xpointmax, string filename, string lobftype){
  ...
  //creating font
  sf::Font font;
  font.loadFromFile(/*"/usr/share/fonts/truetype/ubuntu/Ubuntu-BI.ttf"*/"Optima.ttc");
...
int main() {
  sf::RenderWindow App(sf::VideoMode(1080, 900, 4), "Calculator App");
...
// ----------------------- MODE DEF --------------------------------------
  ...
  int mode = 0; // 0 = Menu, 1 = Pemdas, 2 = Graph, 3 = Calculator, 4 = About
